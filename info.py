...
API_ID = int(environ.get('API_ID', '21938750')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'de453e668c85459cb7f8e981b7a71a69')  # API Hash from my.telegram.org
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6940979626 6796307271').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002033284163 -1002434598772').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002798676125'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002798676125'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002798676125'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002798676125').split()] #(make sure bot is admin)
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002680590809')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002798676125')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+PkWgqAARuiY2ODc1')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1002205349002")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/zhxTPSrd/photo-2025-08-12-16-15-59-7537733592357535748.jpg')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mota.paras@ptaxis')    # Owner UPI ID for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Mota_Paras:parasmota0905@auto-filter-bot.05sclqh.mongodb.net/?retryWrites=true&w=majority&appName=Auto-Filter-bot")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "Mota_Paras") # Database name (default: cluster)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002846854981'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002798676125')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002798676125')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
VERIFY_IMG = environ.get("VERIFY_IMG", "https://telegra.ph/file/9ecc5d6e4df5b83424896.jpg")

TUTORIAL = environ.get("TUTORIAL", "https://t.me/CineHub_Cinema")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/CineHub_Cinema")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/CineHub_Cinema")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "8263ac41d5c084e265c6cc6c44abb5cc80c398aa") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "shortxlinks.com") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "8263ac41d5c084e265c6cc6c44abb5cc80c398aa")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortxlinks.com") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "8263ac41d5c084e265c6cc6c44abb5cc80c398aa")  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+68ylGl42iMwyMzZl') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RajGor_Paras') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+TY67RXAcluBhNTY9') # Update channel link for the bot
